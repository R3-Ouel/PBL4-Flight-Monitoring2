...
- **`server.py`** : Ce script est prévu pour lire les données réelles issues d'un port série (par exemple depuis une carte Arduino, un ESP32 ou tout autre microcontrôleur relié à une centrale inertielle - IMU).
